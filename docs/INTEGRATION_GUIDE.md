...
# RD-Agent (�?G:\test\RD-Agent)
cd G:\test\RD-Agent
pip install -e .

# TradingAgents (�?G:\test\tradingagents-cn-plus)
...
print(f"信心�? {result['final_decision']['confidence']}")
```
